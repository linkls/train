package com.yaowz.train.${module}.service;
...
import com.yaowz.train.common.util.SnowUtil;
import com.yaowz.train.${module}.domain.${Domain};
import com.yaowz.train.${module}.domain.${Domain}Example;
import com.yaowz.train.${module}.mapper.${Domain}Mapper;
